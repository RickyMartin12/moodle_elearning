					...
					<div class="profile row">
						<div class="col-md-12">
							<div class="col-md-12 profile-bottom w3-row-padding tabs row">
								...
								<div class="row">
									<div class="col-md-10 col-sm-12 centering">
										<h4>Users Lists</h4>
									</div>
									<div class="col-md-2 col-sm-12 centering">
										<input type="hidden" id="is_active_group_chat_window" value="no" />
										<button type="button" name="group_chat" id="group_chat" class="btn btn-warning btn-xs"><i class="fas fa-comments-dollar"></i>&nbsp;&nbsp;Group Chat</button>
										<br>
										<br>
									</div>
								</div>
...
$(document).ready(function(){
	...
	function make_chat_dialog_box(to_user_id, to_user_name)
	{
		...
		modal_content+= '<button type="button" name="send_chat" id="'+to_user_id+'" class="btn btn-info send_chat"><i class="fas fa-paper-plane"></i></button></div></div>';
