...
<div id="page-wrapper" class="gray-bg dashbard-1">
    <div class="content-main">
		<div class="banner">
			<h2><a href="index.php">Home</a> <i class="fa fa-angle-right"></i> <a href="#">Main Activities</a> <i class="fa fa-angle-right"></i> <a href="#">Membership Marketing</a> <i class="fa fa-angle-right"></i> <span>Badges</span></h2>
		</div>
					...
					<div class="col-md-12 profile-bottom w3-row-padding tabs row">
						<div class="row">
							<div class="col-md-12">
								<h5 class="col-xs-12 mylabel w3-padding-8 w3-card-2 align_div" ><font style="float: right;"><i class="fas fa-chevron-right" id="mem_off"></i><i class="fas fa-chevron-down" id="mem_on"></i></font>
				                    <span class="fab fa-markdown"></span>&nbsp;&nbsp;Membership Marketing - Badges
			                    </h5>
			                </div>
			           </div>
			           ...
			           <div id="mem_cont">
			              <div class="col-md-12">
			                 <div class="row">
				               <div class="col-md-12">
									<h5 class="col-xs-12 mylabel2 w3-padding-8 w3-card-2 align_div" ><font style="float: right;"><i class="fas fa-chevron-right" id="mem_off_level_1"></i><i class="fas fa-chevron-down" id="mem_on_level_1"></i></font> <span class="fab fa-markdown"></span>&nbsp;&nbsp;Membership Marketing - Badges </h5>
				                </div>
				            </div>
