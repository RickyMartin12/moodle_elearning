...
<div id="page-wrapper" class="gray-bg dashbard-1">
    <div class="content-main">
		<div class="banner">
			<h2><a href="index.php">Home</a> <i class="fa fa-angle-right"></i> <a href="#">Main Activities</a> <i class="fa fa-angle-right"></i> <a href="#">Golf Management</a> <i class="fa fa-angle-right"></i> <span>Badges</span></h2>
		</div>
					...
					<div class="col-md-12 profile-bottom w3-row-padding tabs row">
						<div class="row">
							<div class="col-md-12">
								<h5 class="col-xs-12 mylabel w3-padding-8 w3-card-2 align_div" ><font style="float: right;"><i class="fas fa-chevron-right" id="golf_off"></i><i class="fas fa-chevron-down" id="golf_on"></i></font>
				                    <span class="fas fa-golf-ball"></span>&nbsp;&nbsp;Golf Management - Badges
			                    </h5>
			                </div>
			           </div>
			           ...
			           <div id="golf_cont">
			              <div class="col-md-12">
			                 <div class="row">
				               <div class="col-md-12">
									<h5 class="col-xs-12 mylabel2 w3-padding-8 w3-card-2 align_div" ><font style="float: right;"><i class="fas fa-chevron-right" id="golf_off_level_1"></i><i class="fas fa-chevron-down" id="golf_on_level_1"></i></font> <span class="fas fa-golf-ball"></span>&nbsp;&nbsp;Golf Management Level 1 - Badges </h5>
				                </div>
				            </div>
				            ...
				            <div class="row">
				               <div class="col-md-12">
									<h5 class="col-xs-12 mylabel2 w3-padding-8 w3-card-2 align_div" ><font style="float: right;"><i class="fas fa-chevron-right" id="golf_off_level_2"></i><i class="fas fa-chevron-down" id="golf_on_level_2"></i></font> <span class="fas fa-golf-ball"></span>&nbsp;&nbsp;Golf Management Level 2 - Badges </h5>
				                </div>
				            </div>
