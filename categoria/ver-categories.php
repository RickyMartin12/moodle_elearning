		          	...
		          	for(i=0;i<arr.length;i++)
	            	{
	            		...
	            		for(var i=0; i< files_upl.length; i++)
		        		{
		        			...
		        			switch(fileExtension) 
							{
								...
								case 'png':
								case 'gif':
									v_img += '<div class="w3-content w3-section row" style="max-width:100%"><div class="mySlides row"><div class="col-xs-12"><img src="https://moodle-elearrning.herokuapp.com/categoria/cat/'+files_upl[i]+'" style="width:100%"><br></div></div>';	
								break;                         
								case 'mp4':
								case 'mov':
								case 'vob':
								...
								case 'wmv':
								case 'm4v':
									v_img += '<video class="embed-responsive-item img-responsive" source src="https://moodle-elearrning.herokuapp.com/categoria/cat/'+files_upl[i]+'" type="video/mp4" controls></video>';
								break;
