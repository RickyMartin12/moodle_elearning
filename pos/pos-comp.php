					...
					<div class="col-md-12 profile-bottom w3-row-padding tabs row">
						<div class="row">
							<div class="col-md-12">
								<h5 class="col-xs-12 mylabel w3-padding-8 w3-card-2 align_div" ><font style="float: right;"><i class="fas fa-chevron-right" id="pos_off"></i><i class="fas fa-chevron-down" id="pos_on"></i></font>
				                    <span class="fa fa-credit-card"></span>&nbsp;&nbsp;Point of Sale Solutions - Course competencies
			                    </h5>
			                </div>
			           </div>
			           ...
			           <div id="pos_cont">
			              <div class="col-md-12">
			                 <div class="row">
				               <div class="col-md-12">
									<h5 class="col-xs-12 mylabel2 w3-padding-8 w3-card-2 align_div" ><font style="float: right;"><i class="fas fa-chevron-right" id="pos_off_level_1"></i><i class="fas fa-chevron-down" id="pos_on_level_1"></i></font> <span class="fa fa-credit-card"></span>&nbsp;&nbsp;Point of Sale Solutions Level 1 - Course competencies </h5>
				                </div>
				            </div>
				          ...
				          <div class="col-md-12">
			                 <div class="row">
				               <div class="col-md-12">
									<h5 class="col-xs-12 mylabel2 w3-padding-8 w3-card-2 align_div" ><font style="float: right;"><i class="fas fa-chevron-right" id="pos_off_level_2"></i><i class="fas fa-chevron-down" id="pos_on_level_2"></i></font> <span class="fa fa-credit-card"></span>&nbsp;&nbsp;Point of Sale Solutions Level 2 - Course competencies </h5>
				                </div>
				            </div>
				          ...
				          <div class="col-md-12">
			                 <div class="row">
				               <div class="col-md-12">
									<h5 class="col-xs-12 mylabel2 w3-padding-8 w3-card-2 align_div" ><font style="float: right;"><i class="fas fa-chevron-right" id="pos_off_level_3"></i><i class="fas fa-chevron-down" id="pos_on_level_3"></i></font> <span class="fa fa-credit-card"></span>&nbsp;&nbsp;Point of Sale Solutions Level 3 - Course competencies </h5>
				                </div>
				            </div>
